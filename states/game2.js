...
Game2.prototype = {
    preload: function() {
        ...
        game.load.image('bl_drop', 'assets/img/cokecan.png');
        game.load.image('b2_drop', 'assets/img/milkjug.png');
        game.load.image('b3_drop', 'assets/img/cardboardbox.png');

        game.load.image('r_drop', 'assets/img/usednapkins.png');

        game.load.image('br_drop', 'assets/img/styrofoam.png');
        game.load.image('bucket', 'assets/img/recyclebin.png');

        game.load.image('back_1', 'assets/img/backgrounds_park.jpg');
        game.load.image('back_2', 'assets/img/backgrounds_suburbs.png');
