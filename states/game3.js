...
Game3.prototype = {
    preload: function() {
        ...
        game.load.image('bl_drop', 'assets/img/eggshell.png');
        game.load.image('b2_drop', 'assets/img/applecore.png');
        game.load.image('b3_drop', 'assets/img/teabag.png');

        game.load.image('r_drop', 'assets/img/styrofoam.png');

        game.load.image('br_drop', 'assets/img/meat.png');
        game.load.image('bucket', 'assets/img/compostbin.png');
